...
import {AtLoadingComponent, LoadingMode, LoadingStrategy, LoadingType} from './at-loading.component';
import {AtLoadingFactory, ILoadingRef} from './at-loading.factory';
...
export class AtLoadingConfig implements IAtLoadingConfig {
    ...
    constructor(config: IAtLoadingConfig) {
        ...
        this.message = config.message ? config.message : false;
    }
}
...
export function LOADING_PROVIDER_FACTORY(parent: AtLoadingService, loadingFactory: AtLoadingFactory): AtLoadingService {
