import {
    Component, Input, Output, forwardRef, DoCheck, ViewChild, ViewChildren, QueryList, OnInit, HostListener,
    ElementRef, Optional, Inject, Directive, TemplateRef, ViewContainerRef, ContentChild, ChangeDetectionStrategy,
    ChangeDetectorRef, AfterViewInit, OnDestroy, HostBinding, Renderer2
} from '@angular/core';
...
import {
    coerceBooleanProperty, TemplatePortalDirective, UP_ARROW, DOWN_ARROW,
    ESCAPE, LEFT_ARROW, RIGHT_ARROW, DELETE, BACKSPACE, ENTER, SPACE, TAB, HOME
} from '@angular/cdk';
...
import {ICanDisable, mixinDisabled} from '../at-common/at-common.module';
...
export const _AtChipsMixinBase = mixinDisabled(AtChipsBase);
...
export class AtChipsComponent extends _AtChipsMixinBase implements ControlValueAccessor, DoCheck, OnInit, AfterViewInit, OnDestroy, ICanDisable {
