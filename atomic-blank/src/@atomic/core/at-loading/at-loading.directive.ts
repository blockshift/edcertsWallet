...
import {LoadingType, LoadingMode, LoadingStrategy, AtLoadingComponent} from './at-loading.component';
import {AtLoadingService} from './at-loading.service';
import {ILoadingRef} from './at-loading.factory';
...
export class AtLoadingDirective implements OnInit, OnDestroy {
    ...
    /**
     * atLoadingMessage?: boolean or string | string[]
     * If true and mode is determinate it shows the progress in percent.
     * If true and mode is indeterminate it shows a very well curated loading messages in english.
     * If is a string or string[] and mode is indeterminate it shows the input string.
     * Defaults to false.
     */
    @Input('atLoadingMessage')
    set loadingText(message: any) {
