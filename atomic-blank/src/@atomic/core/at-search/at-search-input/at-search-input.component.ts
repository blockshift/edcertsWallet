...
@Component({
    selector: 'at-search-input',
    templateUrl: './at-search-input.component.html',
    styleUrls: ['./at-search-input.component.scss'],
    animations: [
        trigger('searchState', [
...
export class AtSearchInputComponent implements OnInit {
