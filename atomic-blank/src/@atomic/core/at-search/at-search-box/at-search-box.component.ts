...
@Component({
  selector: 'at-search-box',
  templateUrl: './at-search-box.component.html',
  styleUrls: ['./at-search-box.component.scss' ],
  animations: [
    trigger('inputState', [
      state('0', style({
        width: '0%',
...
export class AtSearchBoxComponent {

  private _searchVisible: boolean = false;
  @ViewChild(AtSearchInputComponent) _searchInput: AtSearchInputComponent;
