import {Component, Input, Output, EventEmitter, OnInit, Optional, ViewEncapsulation} from '@angular/core';
...
@Component({
    selector: 'at-paging-bar',
    templateUrl: './at-paging-bar.component.html',
    styleUrls: ['./at-paging-bar.component.scss'],
    encapsulation: ViewEncapsulation.None
})
export class AtPagingBarComponent implements OnInit {
